...
void MainWindow::on_Start_clicked()
{
    ...
    QString decide="";
    long tempo1 = rand()%2;
    decide = decide+QString::number(tempo1,10);
    decide = decide+"e";
    jud=tempo1;
     QByteArray *array = new QByteArray;
    array->clear();
...
{
    if(OPweather[iu].where!=2&&turn==0)
    {
    if(ingametemp.job==5)
    {
